...
namespace CalendarCodeTests
{
    public class TestConstants
    {
        ...
        public static int defaultCategories = 9;
        public static int defaultCategoriesTypes = 4;
        public static int defaultEvents = 0;
        public static string[] defaultCategoriesTypesDescription = { "Event", "AllDayEvent", "Holiday", "Availability" };
        public static List<string> listCategoryType = new List<string> { "categoryTypes", "categories", "events" };
    }
}
